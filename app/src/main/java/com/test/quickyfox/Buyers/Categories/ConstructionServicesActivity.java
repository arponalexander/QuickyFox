...
public class ConstructionServicesActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycler_construction_services);
        ...
        back.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(ConstructionServicesActivity.this, CategoriesActivity.class);
                ...
                protected void onBindViewHolder(@NonNull ServiceViewHolder holder, int position, @NonNull final Products model)
                {
                    ...
                    holder.itemView.setOnClickListener(new View.OnClickListener(){
                        ...
                        public  void onClick(View view)
                        {
                            ...
                            {
                                Intent intent = new Intent(ConstructionServicesActivity.this, ProductDetailsActivity.class);
