...
public class PlumbingServicesActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycler_plumbing_services);
        ...
        back.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(PlumbingServicesActivity.this, CategoriesActivity.class);
    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerOptions<Products> options =
                new FirebaseRecyclerOptions.Builder<Products>()
                        .setQuery(ProductsRef.orderByChild("Category").equalTo("Plumbing Services"), Products.class)
                        .build();
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull final Products model)
                    {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener(){
                            ...
                            public  void onClick(View view)
                            {
                                ...
                                {
                                    Intent intent = new Intent(PlumbingServicesActivity.this, ProductDetailsActivity.class);
