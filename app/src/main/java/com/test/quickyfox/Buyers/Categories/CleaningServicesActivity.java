...
public class CleaningServicesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycler_cleaning_services);
        ...
        back.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(CleaningServicesActivity.this, CategoriesActivity.class);
    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerOptions<Products> options =
                new FirebaseRecyclerOptions.Builder<Products>()
                        .setQuery(ProductsRef.orderByChild("Category").equalTo("Cleaning Services"), Products.class)
                        .build();
                       ...
                       /* holder.txtProductCategory.setText("Category: " + model.getCategory());*/
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener(){
                            ...
                            public  void onClick(View view)
                            {
                                ...
                                {
                                    Intent intent = new Intent(CleaningServicesActivity.this, ProductDetailsActivity.class);
