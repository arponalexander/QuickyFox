...
public class AirconServiceActivity extends AppCompatActivity
{
    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerOptions<Products> options =
                new FirebaseRecyclerOptions.Builder<Products>()
                        .setQuery(ProductsRef.orderByChild("Category").equalTo("Air Conditioner Cleaning Services"), Products.class)
                        .build();
                    ...
                    protected void onBindViewHolder(@NonNull ServiceViewHolder holder, int position, @NonNull final Products model)
                    {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener(){
                            ...
                            public  void onClick(View view)
                            {
                                ...
                                {
                                    Intent intent = new Intent(AirconServiceActivity.this, ProductDetailsActivity.class);
