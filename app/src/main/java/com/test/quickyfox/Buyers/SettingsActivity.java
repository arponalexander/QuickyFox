...
public class SettingsActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveTextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                AlertDialog.Builder altdial = new AlertDialog.Builder(SettingsActivity.this);
                altdial.setMessage("Are you sure you want to change your Account Information?").setCancelable(false)
    ...
    private void userInfoSaved()
    {
        ...
        if(TextUtils.isEmpty((fullNameEditText.getText().toString())))
        {
            ...
            alert.setTitle("Warning!");
            alert.setIcon(R.drawable.warning);
            alert.setMessage("Please provide your full name..");
            alert.show();
        ...
        else if(TextUtils.isEmpty((addressEditText.getText().toString())))
        {
            ...
            alert.setTitle("Warning!");
            alert.setIcon(R.drawable.warning);
            alert.setMessage("Please provide your address..");
            alert.show();
        ...
        else if(TextUtils.isEmpty((passwordEditText.getText().toString())))
        {
            ...
            alert.setTitle("Warning!");
            alert.setIcon(R.drawable.warning);
            alert.setMessage("Please provide your password..");
            alert.show();
