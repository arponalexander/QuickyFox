...
public class MoverServicesActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_mover_services);
        ProductsRef = FirebaseDatabase.getInstance().getReference().child("Products");


        recyclerView = findViewById(R.id.recycler_mover_services);
        ...
        back.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(MoverServicesActivity.this, CategoriesActivity.class);
    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerOptions<Products> options =
                new FirebaseRecyclerOptions.Builder<Products>()
                        .setQuery(ProductsRef.orderByChild("Category").equalTo("Move and Relocate Services"), Products.class)
                        .build();
                    ...
                    protected void onBindViewHolder(@NonNull ServiceViewHolder holder, int position, @NonNull final Products model)
                    {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener(){
                            ...
                            public  void onClick(View view)
                            {
                                ...
                                {
                                    Intent intent = new Intent(MoverServicesActivity.this, ProductDetailsActivity.class);
