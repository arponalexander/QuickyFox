...
public class SellerAddNewProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //can directly get email getEmail - getUid
    ...
    private void ValidateProductData() {
        ...
        if (ImageUri == null) {
            ...
            Toast.makeText(this, "Please write an product description", Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(Price)) {
            Toast.makeText(this, "Please enter the product price", Toast.LENGTH_SHORT).show();
        } else if (TextUtils.isEmpty(Pname)) {
            Toast.makeText(this, "Please provide a name for your product", Toast.LENGTH_SHORT).show();
        } else {
    ...
    private void StoreProductInformation()
    {
        ...
        loadingbar.setMessage( "Please wait, while we are adding your service");
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            Toast.makeText(SellerAddNewProductActivity.this, "got Product image Url Successful", Toast.LENGTH_SHORT).show();
