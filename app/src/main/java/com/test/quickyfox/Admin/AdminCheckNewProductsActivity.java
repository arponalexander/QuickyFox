...
public class AdminCheckNewProductsActivity extends AppCompatActivity {
    ...
    protected void onStart()
    {
        ...
        final FirebaseRecyclerAdapter<Products, ServiceViewHolder> adapter = new FirebaseRecyclerAdapter<Products, ServiceViewHolder>(options)
        {
            @Override
            protected void onBindViewHolder(@NonNull ServiceViewHolder holder, int position, @NonNull final Products model)
            {
               ...
               holder.itemView.setOnClickListener(new View.OnClickListener()
               {
                   ...
                   public void onClick(View view)
                   {
                       ...
                       builder.setTitle("Approved this Service?");
    ...
    private void ChangeProductState(String productID)
    {
        unverifiedProductsRef.child(productID).child("productState").setValue("Approved").addOnCompleteListener(new OnCompleteListener<Void>()
        {
            ...
            public void onComplete(@NonNull Task<Void> task)
            {
                ...
                Toast.makeText(AdminCheckNewProductsActivity.this, "The Service has been approved", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
